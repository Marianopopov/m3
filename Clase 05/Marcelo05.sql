...
ALTER TABLE `empleados` CHANGE `Id_Empleado` `IdEmpleado` INT(11) NULL DEFAULT NULL;

ALTER TABLE `proveedores` DROP PRIMARY KEY;
ALTER TABLE `proveedores` CHANGE `IDProveedor` `IdProveedor` INT(11) NULL DEFAULT NULL;
...
ALTER TABLE `productos` CHANGE `ID_PRODUCTO` `IdProducto` INT(11) NULL DEFAULT NULL;
...
---------------- por aca
ALTER TABLE `empleados` ADD `Salario` DECIMAL(10,2) NOT NULL DEFAULT '0' AFTER `Salario2`;
...
## Punto 9
SELECT * FROM venta WHERE precio = '';
